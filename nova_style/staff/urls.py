...
urlpatterns = [
   ...
   path('admin-order-detail/<int:order_id>/status',views.order_status,name="order_status"),
   path('admin-order-returns/',views.admin_order_returns,name="admin_order_returns"),
   path('admin-order-returns/details/<int:return_id>/',views.return_details,name="return_details"),
   path('admin-order-returns/details/<int:return_id>/status/',views.update_return_status,name="update_return_status"),
